...
class Solution:
    def maxProbability(
        ...
        for i, (u, v) in enumerate(edges):
            neighbors[u].append((succ_prob[i], v))
            neighbors[v].append((succ_prob[i], u))
        ...
        while pq:
            ...
            for next_prob, next_node in neighbors[curr_node]:
                prob = -curr_prob * next_prob
                if prob > probs[next_node]:
                    probs[next_node] = prob
                    heappush(pq, (-prob, next_node))
