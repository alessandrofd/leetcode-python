...
class Solution:
    ...
    # intermediários.
    #
    # Podemos perceber que a solução baseada em programação dinâmica, a cada
    # iteração das colunas, utiliza apenas as informações da coluna anterior.
    # Logo, não há a necessidade de armazernarmos todas a matriz. Uma das
    # alternativas é utilizar dois vetores, um contendo os dados da coluna
    # anterior e outro da coluna sob processamento. No entanto, se invertermos
    # a ordem de processamento das letras do alvo, talvez seja possível
    # trabalhar com um único vetor.
